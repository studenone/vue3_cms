...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const isCreate = usePermissions(props.pageName, 'delete')
    const isCreate = usePermissions(props.pageName, 'update')
    const isCreate = usePermissions(props.pageName, '')
    ...
    console.log('[dynamic]', dynamicSlots)
