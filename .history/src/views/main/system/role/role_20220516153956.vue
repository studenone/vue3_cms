...
import { useTreeOption } from '@/hooks/use-tree-option'
...
export default defineComponent({
  ...
  setup() {
    ...
    const treeEditCb = (row: any) => {
      const list = useTreeOption(row.menuList)
      console.log('[]row', row, list)
      // treeRef.value!.setCheckedKeys([...row.menuList], false)
    }
    const treeCreateCb = () => {
